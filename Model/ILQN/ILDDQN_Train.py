...
def IL_DDQN_train(episode, minimum, stockName, args):
    ...
    # 模型保存
    PATH = r'..\..\Result\parameter_sensitivity\agent_ddqn_' + stockName + '_' + str(args.lambda_1).replace('.', '_') + '_' + '.pt'
    ...
    plt.title('ILDDQN: The Episode Reward of ' + Name)
    plt.grid()
...
if __name__ == '__main__':
    ...
    #     print('Stock', name)
    #     IL_DDQN_train(episode=15, minimum=1500, stockName=name, args=args)
    print('Stock', stockName[2])
    IL_DDQN_train(episode=5, minimum=1500, stockName=stockName[2], args=args)
